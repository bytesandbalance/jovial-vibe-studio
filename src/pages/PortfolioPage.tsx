      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="space-y-24">
          ...
          <section className="border-b border-border/50 pb-16">
            ...
            {/* Cards */}
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center items-center sm:items-stretch px-4">
              <div className="group cursor-pointer w-full sm:w-1/3 max-w-[280px] sm:max-w-[320px] md:max-w-none mx-auto">
